...
add_plot = [
    mpf.make_addplot(stock_data["ema_20"], color="maroon", label="20-day EMA"),
    mpf.make_addplot(stock_data["ema_50"], color="blue", label="50-day EMA"),
]
