...
from keys.api_work.databases.postgres import (
    SG_TRADING_2_MARKETDATA_READ,
    SG_TRADING_2_MARKETDATA_WRITE,
)
...
if __name__ == "__main__":
    ...
    postgres_client = SqlAlchemyConnector(SG_TRADING_2_MARKETDATA_READ)
