...
class MarginTwapAlgoMarket(Bybit, LoggerClient, Telegram):
    """
    Args:
...
if __name__ == "__main__":
    ...
    # config_path = "C:/Users/EdgarTan/Documents/Github/python/config/trade_execution_algos/bybit/bybit_spot_twap_market.ini"
