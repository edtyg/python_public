"""
Binance Cross Margin TWAP Execution algo
"""
...
class TwapAlgo(BinanceCrossMargin, LoggerClient, Telegram):
    """
    Args:
    ...
    def twap_order_checking(self, order_params: dict):
        ...
        print(f"cross margin {self.base_ticker} balance = {base_asset_balance}")
        base_asset_balance_val = (
            self.get_coin_value(self.base_ticker) * base_asset_balance
        )
        print(f"cross margin {self.base_ticker} valuation = {base_asset_balance_val}")

        # quote asset
        quote_asset_balance = self.get_margin_account_balance(self.quote_ticker)
        print(f"cross margin {self.quote_ticker} balance = {quote_asset_balance}")
        quote_asset_balance_val = (
            self.get_coin_value(self.quote_ticker) * quote_asset_balance
        )
        print(f"cross margin {self.quote_ticker} valuation = {quote_asset_balance_val}")
        print("\n")
