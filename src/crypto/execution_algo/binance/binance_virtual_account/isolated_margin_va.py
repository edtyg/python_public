...
class VirtualAccount(BinanceSpot, BinanceIsolatedMargin, LoggerClient):
    """
    Args:
        BinanceSpot (_type_): binance spot client
        BinanceIsolatedMargin (_type_): binance isolated margin client
    ...
    def main(self):
        ...
        while status is True:
            print(
                ...
                \n\
                \nEnter 2 for Margin - Isolated Margin Balances\
                \nEnter 3 for Margin - Spot to Isolated Margin Transfer\
                \nEnter 4 for Margin - Isolated Margin to Spot Transfer\
                \nEnter 5 for Margin - Repay Isolated Margin Borrows\
                \n\
                \nEnter 6 for Margin - Place Isolated Margin Limit Order\
                \nEnter 7 for Margin - Check Isolated Margin Open Orders\
                \nEnter 8 for Margin - Close A Specific Isolated Margin Order\
                \n\
                \nEnter 0 to exit"
            )
            ...
            if input_number == "1":
                ...
                isolated_symbol = input(
                    "Enter Isolated Margin Symbol to transfer to: "
                ).upper()
                ...
                amt = input("Amount of asset to transfer e.g 0.1: ")
                isolated_symbol = input(
                    "Enter Isolated Margin Symbol to transfer from: "
                ).upper()
                ...
                amt = input("Amount of asset to transfer e.g 0.1: ")
                isolated_symbol = input(
                    "Enter Isolated Margin Symbol to Repay to: "
                ).upper()
