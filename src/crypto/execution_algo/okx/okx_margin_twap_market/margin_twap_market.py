...
class MarginTwapAlgoMarket(Okx, LoggerClient, Telegram):
    """
    Args:
...
if __name__ == "__main__":
    ...
    # config_path = "C:/Users/EdgarTan/Documents/Github/python/config/trade_execution_algos/okx/okx_margin_twap_market.ini"
