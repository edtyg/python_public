...
def get_usdm_order_history(
    client,
    usdm_symbol: str,
    start_time: Optional[int] = None,
):
    """Gets usdm order history with time specified
...
if __name__ == "__main__":
    ...
    start_time = int(dt.datetime(2024, 3, 15, 12, 0, 0).timestamp() * 1000)

    orders = get_usdm_order_history(
        usdm_client_read,
        usdm_symbol,
        start_time,
    )
