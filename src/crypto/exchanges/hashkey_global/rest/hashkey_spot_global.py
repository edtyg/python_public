...
from local_credentials.api_personal.crypto_exchanges.hashkey import HASHKEY_GLOBAL_TRADE
from python.crypto.exchanges.hashkey.rest.hashkey_global.hashkey_client_global import (
    HashkeyExchange,
)
...
class HashkeySpot(HashkeyExchange):
    ...
    def post_create_order(self, params: dict) -> dict:
        ...
        response = self._post_signed(endpoint, params)
        return response
...
if __name__ == "__main__":
    ...
    # acc_trade_list = client.get_account_trade_list()
    # print(acc_trade_list)
