...
if __name__ == "__main__":
    ...
    # order parameters
    params = {
        "base_ticker": "ADA",  # base ticker
        "quote_ticker": "USDT",  # quote ticker
        "binance_symbol": "ADAUSDT",  # full ticker
        "direction": "SELL",  # BUY or SELL
        "clip_size_type": "base",  # 'base' or 'quote' currency
        "total_trade_size": 450,  # trade size in clip_size_type
        "clip_value_limit": 5000,  # clip size limit of 5k USD per clip
        "total_twap_time_seconds": 100,  # total time of twap
